...
export class AuditLogService {
  ...
  async getStatistics(
    ...
    try {
      ...
      return await this.auditLogRepository.getStatistics(
        statisticsOptions as AuditStatisticsOptions
      );
    } catch (error) {
  ...
  async generateComplianceReport(
    ...
    try {
      ...
      const { logs, total } = await this.auditLogRepository.search(
        searchOptions as AuditSearchOptions
      );
