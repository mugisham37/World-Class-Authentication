...
export class EmailOtpService {
   ...
   */
  async sendOtp(userId: string, email: string, options: Record<string, any> = {}): Promise<Record<string, any>> {
    try {
   ...
   */
  async verifyOtp(otpId: string, code: string, options: Record<string, any> = {}): Promise<Record<string, any>> {
    try {
