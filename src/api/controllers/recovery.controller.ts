...
export class RecoveryController extends BaseController {
   ...
   */
  getUserRecoveryMethods = this.handleAsync(
   ...
   */
  registerRecoveryMethod = this.handleAsync(
    async (req: ExtendedRequest, res: Response): Promise<void> => {
      // Check if user is authenticated
      if (!req.user) {
        throw new AuthenticationError('Not authenticated', 'NOT_AUTHENTICATED');
   ...
   */
  disableRecoveryMethod = this.handleAsync(
    async (req: ExtendedRequest, res: Response): Promise<void> => {
      // Check if user is authenticated
      if (!req.user) {
        throw new AuthenticationError('Not authenticated', 'NOT_AUTHENTICATED');
   ...
   */
  enableRecoveryMethod = this.handleAsync(
    async (req: ExtendedRequest, res: Response): Promise<void> => {
      // Check if user is authenticated
      if (!req.user) {
        throw new AuthenticationError('Not authenticated', 'NOT_AUTHENTICATED');
   ...
   */
  initiateRecovery = this.handleAsync(
    async (req: ExtendedRequest, res: Response): Promise<void> => {
   ...
   */
  verifyRecoveryChallenge = this.handleAsync(
    async (req: ExtendedRequest, res: Response): Promise<void> => {
   ...
   */
  completeRecovery = this.handleAsync(
    async (req: ExtendedRequest, res: Response): Promise<void> => {
   ...
   */
  cancelRecoveryRequest = this.handleAsync(
    async (req: ExtendedRequest, res: Response): Promise<void> => {
      // Check if user is authenticated
      if (!req.user) {
        throw new AuthenticationError('Not authenticated', 'NOT_AUTHENTICATED');
   ...
   */
  validateRecoveryRequest = (req: ExtendedRequest, next: NextFunction): void => {
    const { requestId } = req.params;
