...
export class PerformanceController extends BaseController {
   ...
   */
  getMetrics = this.handleAsync(async (req: Request, res: Response): Promise<void> => {
   ...
   */
  getDashboardData = this.handleAsync(async (req: Request, res: Response): Promise<void> => {
    // Check if user is authenticated and has admin role
    if (!req.user) {
      throw new AuthenticationError('Not authenticated', 'NOT_AUTHENTICATED');
    }
   ...
   */
  getRealTimeData = this.handleAsync(async (req: Request, res: Response): Promise<void> => {
    // Check if user is authenticated and has admin role
    if (!req.user) {
      throw new AuthenticationError('Not authenticated', 'NOT_AUTHENTICATED');
    }
   ...
   */
  getAlerts = this.handleAsync(async (req: Request, res: Response): Promise<void> => {
    // Check if user is authenticated and has admin role
    if (!req.user) {
      throw new AuthenticationError('Not authenticated', 'NOT_AUTHENTICATED');
    }
   ...
   */
  getDatabaseMetrics = this.handleAsync(async (req: Request, res: Response): Promise<void> => {
    // Check if user is authenticated and has admin role
    if (!req.user) {
      throw new AuthenticationError('Not authenticated', 'NOT_AUTHENTICATED');
    }
   ...
   */
  getCacheMetrics = this.handleAsync(async (req: Request, res: Response): Promise<void> => {
    // Check if user is authenticated and has admin role
    if (!req.user) {
      throw new AuthenticationError('Not authenticated', 'NOT_AUTHENTICATED');
    }
   ...
   */
  getEndpointMetrics = this.handleAsync(async (req: Request, res: Response): Promise<void> => {
    // Check if user is authenticated and has admin role
    if (!req.user) {
      throw new AuthenticationError('Not authenticated', 'NOT_AUTHENTICATED');
    }
