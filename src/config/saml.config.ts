...
const rawConfig = {
  ...
  serviceProvider: {
    ...
    attributeConsumingServiceIndex: process.env.SAML_SP_ACS_INDEX ? parseInt(process.env.SAML_SP_ACS_INDEX) : undefined,
  ...
  identityProviders: process.env.SAML_IDP_CONFIG
    ? JSON.parse(process.env.SAML_IDP_CONFIG)
    : [],
  session: {
